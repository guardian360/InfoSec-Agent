...
func CookieFirefox() checks.Check {
	...
	if err != nil {
		return checks.NewCheckErrorf(26, "No firefox directory found", err)
	}
	...
	if copyError != nil {
		return checks.NewCheckErrorf(26, "Unable to make a copy of the file", copyError)
	}

	db, err := sql.Open("sqlite", tempCookieDbff)
	if err != nil {
		return checks.NewCheckError(26, err)
	}
	...
	if rows.Err() != nil {
		return checks.NewCheckError(26, rows.Err())
	}
	if err != nil {
		return checks.NewCheckError(26, err)
	}
	...
	return checks.NewCheckResult(26, 0, output...)
}
