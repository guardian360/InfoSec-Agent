...
func Startup(key1 registrymock.RegistryKey, key2 registrymock.RegistryKey, key3 registrymock.RegistryKey) Check {
	...
	if err1 != nil || err2 != nil || err3 != nil {
		return NewCheckError(19, errors.New("error opening registry keys"))
	}
	...
	if err1 != nil || err2 != nil || err3 != nil {
		return NewCheckError(19, errors.New("error reading value names"))
	}

	if len(slices.Concat(cuValueNames, lmValueNames, lm2ValueNames)) == 0 {
		return NewCheckResult(19, 0, "No startup programs found")
	}
	...
	return NewCheckResult(19, 1, output...)
}
