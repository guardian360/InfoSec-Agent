...
func TestWindowsOutdated(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			want: checks.NewCheckResult(17, 0, "11.0.22631",
		...
		},
		{
			...
			want: checks.NewCheckResult(17, 0, "11.0.22630",
		...
		},
		{
			...
			want: checks.NewCheckResult(17, 0, "9.0.0",
