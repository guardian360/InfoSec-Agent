...
type MockCopyDBGetter struct {
	CopyDatabaseFunc func(source string, getter browsers.CopyFileGetter) (string, error)
}

func (m MockCopyDBGetter) CopyDatabase(source string, getter browsers.CopyFileGetter) (string, error) {
	return m.CopyDatabaseFunc(source, getter)
}
...
func TestHistoryChromium_Success(t *testing.T) {
	...
	mockCopyGetter := MockCopyDBGetter{
		CopyDatabaseFunc: func(_ string, _ browsers.CopyFileGetter) (string, error) {
